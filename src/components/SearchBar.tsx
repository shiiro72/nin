  ...
  return (
    <form onSubmit={handleSearch} className="flex w-full max-w-md gap-2">
      ...
      <button
        type="submit"
        disabled={loading}
        className="flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 font-medium text-white transition-colors hover:bg-blue-700 disabled:opacity-50 cursor-pointer"
      >
        {loading ? 'Searching...' : (
          <>
            <Search size={18} />
